                    ...
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="wow fadeInUp" data-wow-delay="0.4s">
                            <div class="section-heading">
                                <h2>Consultar Reserva <br/>ou Locação</h2>
                              </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="wow bounceInUp" data-wow-delay="0.2s">  
                        <div class="inner">
                                ...
                                <asp:TextBox ID="TextBox1" runat="server" Height="28px" Width="522px">Codigo de Reserva ou Codigo de Locação</asp:TextBox>
                                               <br/><br/>
                                <asp:Button ID="Button2" runat="server" Text="Consultar" Width="140px" style="background-color: #1E3760; font-weight: 700; color: #FFFFFF;" Height="33px"/>
                                </asp:Panel>
